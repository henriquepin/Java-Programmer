...
public abstract class Funcionario {
	...
	final static String EMPRESA = "xpto S.A."; //constantes precisam ser inicializadas. Precisa dos modificadores "final" e "static"
	
	private String nome;
	protected double salario;
	private int idade;
	public Endereco endereco;// relacionamento de uso
